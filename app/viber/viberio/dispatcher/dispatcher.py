...
from viberio.fsm.storages.base import BaseStorage, StorageKey
...
class Dispatcher(DataMixin, ContextInstanceMixin):
    def __init__(self, viber: ViberBot, storage: typing.Optional[BaseStorage] = None):
        if storage is None:
            raise ValueError("Storage must be")
    ...
    def current_state(self, request: requests.ViberMessageRequest) -> typing.Union[
        typing.ContextManager[FSMContext], FSMContext
    ]:
